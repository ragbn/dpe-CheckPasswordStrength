...
namespace CheckPasswordStrength
{
    ...
    public class UtilFrequencyList
    {
        ...
        /// <summary>
        /// Subtract the value of ' ' from each of thethree, then ((((first_value * 95) + second_value) * 95) + third_value) will
        /// give you the odds that this pair is grouped together
        /// </summary>
        internal static void Parse_Frequency_Token()
        {
            double c;
            c = Frequency_List[0] - ' ';
            c /= 95;
            ...
            c += Frequency_List[2] - ' ';
            c /= 95;
            Frequency_List = Frequency_List.Substring(3);
            FrequencyTable.Add(FrequencyTable.Count, c);
        }
    }
}
